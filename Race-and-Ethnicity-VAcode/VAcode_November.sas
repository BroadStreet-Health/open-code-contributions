/*Code for November, 2020. Completed 1/18/21. Jessica Song*/
filename Wider 
		'C:\Users\16147\OneDrive - Kent State University\Kent State\Active Projects\BroadStreet_COVID\For SAS\November_Wide.xlsx';
...
proc contents data=wider; run; /*Check for number of days (variables go to 29 or 30?) 29 here.*/
...
data long_Aug;
   ...
   drop _name_;
	...
	proc contents data=long_aug; run;/*Which are character variables? Must change below.
										NonHispanic, Pacific, Unspec.*/
...
PROC EXPORT DATA= WORK.final
            OUTFILE= 'C:\Users\16147\OneDrive - Kent State University\Kent State\Active Projects\BroadStreet_COVID\Final Products\November.xlsx'
            DBMS=EXCEL REPLACE; 
RUN;
